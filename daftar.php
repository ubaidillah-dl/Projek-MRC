        ...
        <div class="row">
            ...
            <div class="content">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <!-- Nama instansi start -->
                    <div class="nama-instansi input"><label for="nama-instansi">Nama Instansi</label><input autocomplete="off" required type="text" id="nama-instansi" placeholder="Masukkan Nama Instansi" name="nama_instansi" /></div>
                    <!-- Nama instansi start -->
                    ...
                    <!-- Ktm ketua start -->
                    <div class="ktm-ketua input"><label for="ktm-ketua">KTM Ketua</label><input autocomplete="off" required class="unggah" name="ktm_ketua" type="file" id="ktm-ketua" /></div>
                    <!-- Ktm ketua start -->

                    <!-- Bukti up twibbon ketua start -->
                    <div class="bukti-uptwibbon-ketua input"><label for="bukti-uptwibbon-ketua">Bukti Up Twibbon
                            Ketua</label><input autocomplete="off" required class="unggah" type="file" name="bukti_up_twibbon_ketua" id="bukti-uptwibbon-ketua" /></div>
                    <!-- Bukti up twibbon ketua end -->

                    <!-- Nama anggota start -->
                    <div class="nama-anggota input"><label for="nama-anggota">Nama Anggota</label><input autocomplete="off" required name="nama_anggota" type="text" id="nama-anggota" placeholder="Masukkan Nama Anggota" /></div>
                    <!-- Nama anggota start -->

                    <!-- Ktm anggota start -->
                    <div class="ktm-anggota input"><label for="ktm-anggota">KTM Anggota</label><input autocomplete="off" required class="unggah" name="ktm_anggota" type="file" id="ktm-anggota" /></div>
                    <!-- Ktm anggota end -->

                    <!-- Bukti up twibbon anggota start -->
                    <div class="bukti-uptwibbon-anggota input">
                        <label for="bukti-uptwibbon-anggota">Bukti Up Twibbon Anggota</label><input autocomplete="off" required class="unggah" type="file" id="bukti-uptwibbon-anggota" name="bukti_up_twibbon_anggota" />
                    </div>
